...
" Pet peeves
inoremap <C-R><C-R> As a reminder (see syllabus 3.2, item 6), it's appreciated if you can include the sources of problems (e.g. "Shortlist 2018 A7") when provided. The problem numbers can often change during edits.

...
#let thm = thm-plain("Theorem", padding: (x: 0.5em, y: 0.6em), outset: 0.9em, fill: rgb("#eeeeff"), counter: "thm")
#let lem = thm-plain("Lemma", padding: (x: 0.5em, y: 0.6em), outset: 0.9em, fill: rgb("#eeeeff"), counter: "thm")
#let prop = thm-plain("Proposition", padding: (x: 0.5em, y: 0.6em), outset: 0.9em, fill: rgb("#eeeeff"), counter: "thm")
#let cor = thm-plain("Corollary", padding: (x: 0.5em, y: 0.6em), outset: 0.9em, fill: rgb("#eeeeff"), counter: "thm")
#let conj = thm-plain("Conjecture", padding: (x: 0.5em, y: 0.6em), outset: 0.9em, fill: rgb("#eeeeff"), counter: "thm")
#let ex = thm-def("Example", padding: (x: 0.5em, y: 0.6em), outset: 0.9em, fill: rgb("#ffeeee"), counter: "thm")
#let algo = thm-def("Algorithm", padding: (x: 0.5em, y: 0.6em), outset: 0.9em, fill: rgb("#ddffdd"), counter: "thm")
#let claim = thm-def("Claim", padding: (x: 0.5em, y: 0.6em), outset: 0.9em, fill: rgb("#ddffdd"), counter: "thm")
#let rmk = thm-def("Remark", padding: (x: 0.5em, y: 0.6em), outset: 0.9em, fill: rgb("#eeeeee"), counter: "thm")
#let defn = thm-def("Definition", padding: (x: 0.5em, y: 0.6em), outset: 0.9em, fill: rgb("#ffffdd"), counter: "thm")
#let prob = thm-def("Problem", padding: (x: 0.5em, y: 0.6em), outset: 0.9em, fill: rgb("#eeeeee"), counter: "thm")
#let exer = thm-def("Exercise", padding: (x: 0.5em, y: 0.6em), outset: 0.9em, fill: rgb("#eeeeee"), counter: "thm")
#let exerstar = thm-def("* Exercise", padding: (x: 0.5em, y: 0.6em), outset: 0.9em, fill: rgb("#eeeeee"), counter: "thm")
#let ques = thm-def("Question", padding: (x: 0.5em, y: 0.6em), outset: 0.9em, fill: rgb("#eeeeee"), counter: "thm")
#let fact = thm-def("Fact", padding: (x: 0.5em, y: 0.6em), outset: 0.9em, fill: rgb("#eeeeee"), counter: "thm")

...
os.system("cp -f /home/evan/Dropbox/Documents/Blog/demacro-private.sty /tmp")
os.chdir("/tmp")
os.system("de-macro source.tex")
os.system("python2 /home/evan/Dropbox/Documents/Blog/latex2wp/latex2wp.py source-clean.tex")

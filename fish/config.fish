...
if test (uname) = "Linux"
	...
	function ll
		...
		set --function regex $regex'\.(aux|bbl|bcf|blg|fdb_latexmk|fls|log|maf|mtc0?|out|pre|ptc[0-9]+|pytxcode|pytxmcr|pytxpyg|run\.xml|toc|synctex\.gz|von)|-[0-9]{1,2}\.(asy|pdf)$'

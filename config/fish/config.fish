...
alias oscar='/usr/bin/python3 ~/dotfiles/py-scripts/oscar/'
...
alias gpg-status="~/dotfiles/sh-scripts/gpg-status.sh"
...
alias plmk="latexmk -r ~/dotfiles/misc/pytex-latexmkrc"
alias push-to-prod='~/dotfiles/sh-scripts/push-to-prod.sh'
